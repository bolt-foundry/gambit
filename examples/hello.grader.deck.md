...
inputSchema = "./hello_world/schemas/calibration_session_input.zod.ts"
outputSchema = "./hello_world/schemas/grader_output.zod.ts"
[modelParams]
model = "openai/gpt-4o-mini"
temperature = 0
+++

You verify the assistant follows the exact hello echo rules.
