...
// @ts-nocheck: legacy reference-only file retained for cutover context; excluded from type safety guarantees
// deno-lint-ignore-file no-console no-unused-vars gambit/no-useeffect-setstate gambit/no-useeffect-setstate
...
import type Icon from "./gds/Icon.tsx";
...
export function ChatView(props: {
  ...
  const handleSendChat = useCallback(async () => {
    ...
    const activeContexts: Array<WorkbenchMessageContext> = [];
