...
import { GambitWorkspaceScenarioRunStopMutation as resolver } from '../../../../mutations/GambitWorkspaceScenarioRunStop.tsx';
...
const readerAst: ReaderAst<Mutation__GambitWorkspaceScenarioRunStop__param> = [
  {
    kind: "Linked",
...
> = {
  ...
  fieldName: "GambitWorkspaceScenarioRunStop",
  resolver,
  readerAst,
  hasUpdatable: false,
};
