import type { Mutation__GambitWorkspaceVerifyBatchRunCreate__parameters } from './parameters_type.ts';

export type Mutation__GambitWorkspaceVerifyBatchRunCreate__param = {
  readonly data: {
  ...
  readonly parameters: Mutation__GambitWorkspaceVerifyBatchRunCreate__parameters,
};
