...
import { Mutation__GambitWorkspaceScenarioRunSend__param } from './param_type.ts';
import { Mutation__GambitWorkspaceScenarioRunSend__output_type } from './output_type.ts';
import { GambitWorkspaceScenarioRunSendMutation as resolver } from '../../../../mutations/GambitWorkspaceScenarioRunSend.tsx';
...
const readerAst: ReaderAst<Mutation__GambitWorkspaceScenarioRunSend__param> = [
  {
    kind: "Linked",
    fieldName: "workspaceScenarioRunSend",
    alias: null,
    arguments: [
      [
        "input",
...
const artifact: EagerReaderArtifact<
  Mutation__GambitWorkspaceScenarioRunSend__param,
  Mutation__GambitWorkspaceScenarioRunSend__output_type
> = {
  kind: "EagerReaderArtifact",
  fieldName: "GambitWorkspaceScenarioRunSend",
  resolver,
  readerAst,
  hasUpdatable: false,
};
