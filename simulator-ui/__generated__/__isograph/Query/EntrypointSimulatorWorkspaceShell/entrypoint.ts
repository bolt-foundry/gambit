...
import type {Query__EntrypointSimulatorWorkspaceShell__raw_response_type} from './raw_response_type.ts';
...
const artifact: IsographEntrypoint<
  ...
  NormalizationAst,
  Query__EntrypointSimulatorWorkspaceShell__raw_response_type
> = {
  kind: "Entrypoint",
  networkRequestInfo: {
