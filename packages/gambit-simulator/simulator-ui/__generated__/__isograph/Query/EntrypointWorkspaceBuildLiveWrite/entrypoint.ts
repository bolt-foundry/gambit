...
import type {Query__EntrypointWorkspaceBuildLiveWrite__raw_response_type} from './raw_response_type.ts';
...
const artifact: IsographEntrypoint<
  ...
  NormalizationAst,
  Query__EntrypointWorkspaceBuildLiveWrite__raw_response_type
> = {
  kind: "Entrypoint",
  networkRequestInfo: {
