...
import type {Query__EntrypointWorkspaceWorkbenchLiveWrite__raw_response_type} from './raw_response_type.ts';
...
const artifact: IsographEntrypoint<
  ...
  NormalizationAst,
  Query__EntrypointWorkspaceWorkbenchLiveWrite__raw_response_type
> = {
  kind: "Entrypoint",
  networkRequestInfo: {
