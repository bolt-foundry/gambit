...
import type {Mutation__GambitWorkspaceGradeFlagToggle__raw_response_type} from './raw_response_type.ts';
...
const artifact: IsographEntrypoint<
  ...
  NormalizationAst,
  Mutation__GambitWorkspaceGradeFlagToggle__raw_response_type
> = {
  kind: "Entrypoint",
  networkRequestInfo: {
