...
import type {Mutation__GambitWorkspaceScenarioRunStart__raw_response_type} from './raw_response_type.ts';
...
const artifact: IsographEntrypoint<
  ...
  NormalizationAst,
  Mutation__GambitWorkspaceScenarioRunStart__raw_response_type
> = {
  kind: "Entrypoint",
  networkRequestInfo: {
