...
import type {Mutation__GambitWorkspaceConversationSessionStop__raw_response_type} from './raw_response_type.ts';
...
const artifact: IsographEntrypoint<
  ...
  NormalizationAst,
  Mutation__GambitWorkspaceConversationSessionStop__raw_response_type
> = {
  kind: "Entrypoint",
  networkRequestInfo: {
