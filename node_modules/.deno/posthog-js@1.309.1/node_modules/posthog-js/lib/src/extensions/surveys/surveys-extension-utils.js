...
var addSurveyCSSVariablesToElement = function (element, type, appearance) {
    ...
    var inputBgColor = (appearance === null || appearance === void 0 ? void 0 : appearance.inputBackgroundColor) || effectiveAppearance.inputBackground;
    if (!(appearance === null || appearance === void 0 ? void 0 : appearance.inputBackgroundColor) && effectiveAppearance.backgroundColor === 'white') {
        inputBgColor = '#f8f8f8';
    }
    hostStyle.setProperty('--ph-survey-input-background', inputBgColor);
    hostStyle.setProperty('--ph-survey-input-text-color', (appearance === null || appearance === void 0 ? void 0 : appearance.inputTextColor) || getContrastingTextColor(inputBgColor));
