...
var ProductTourSurveyStep_1 = require("./components/ProductTourSurveyStep");
...
var ProductTourManager = /** @class */ (function () {
    ...
    ProductTourManager.prototype.showTourById = function (tourId) {
        ...
        (_a = this._instance.productTours) === null || _a === void 0 ? void 0 : _a.getProductTours(function (tours) {
            ...
            if (tour) {
                ...
                _this.showTour(tour, { reason: 'api' });
            }
            else {
    ...
    ProductTourManager.prototype._renderSurveyStep = function () {
        ...
        (0, preact_1.render)((0, jsx_runtime_1.jsx)(ProductTourSurveyStep_1.ProductTourSurveyStep, { tour: this._activeTour, step: step, stepIndex: this._currentStepIndex, totalSteps: this._activeTour.steps.length, onSubmit: handleSubmit, onPrevious: this.previousStep, onDismiss: handleDismiss }), shadow);
