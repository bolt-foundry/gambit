...
```bash
deno run -A jsr:@molt-foundry/gambit/cli serve ./agent_with_multi_actions.deck.md
```

## Run in the CLI

```bash
deno run -A jsr:@molt-foundry/gambit/cli run ./agent_with_multi_actions.deck.md \
