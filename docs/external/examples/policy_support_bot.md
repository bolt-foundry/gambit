...
This example (located at `init/examples/advanced/policy_support_bot/`) shows how
to combine Markdown decks and compute action decks to build a refusal-first
