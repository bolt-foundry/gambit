...
This example (located at `examples/advanced/policy_support_bot/`) shows how to
combine Markdown decks and compute action decks to build a refusal-first support
bot grounded entirely in a curated FAQ.
